...
{pstd}
{cmd:estat impact} estimates the mean of the direct, indirect, and total impacts of the independent variables in {it:varlist} on the reduced-form mean of the dependent variable; see Kripfganz and Sarafidis (2024) for details.
...
{it:Journal of Statistical Software}: forthcoming.
